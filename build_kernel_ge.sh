...
# 
make -j3 0googymax3_GE_defconfig VARIANT_DEFCONFIG=jf_eur_defconfig SELINUX_DEFCONFIG=selinux_defconfig SELINUX_LOG_DEFCONFIG=selinux_log_defconfig || exit 1
...
mkdir -p /home/googy/Anas/Googy-Max3-Kernel/GT-I9505_GoogyMax3_GE.CWM/system/lib/modules
rm -rf /home/googy/Anas/Googy-Max3-Kernel/GT-I9505_GoogyMax3_GE.CWM/system/lib/modules/*
find -name '*.ko' -exec cp -av {} /home/googy/Anas/Googy-Max3-Kernel/GT-I9505_GoogyMax3_GE.CWM/system/lib/modules/ \;
${CROSS_COMPILE}strip --strip-unneeded /home/googy/Anas/Googy-Max3-Kernel/GT-I9505_GoogyMax3_GE.CWM/system/lib/modules/*
...
zip -v -r ../GT-I9505_GoogyMax3_GE-Kernel_${1}_CWM.zip .

adb push /home/googy/Anas/Googy-Max3-Kernel/GT-I9505_GoogyMax3_GE-Kernel_${1}_CWM.zip /storage/sdcard0/GT-I9505_GoogyMax3_GE-Kernel_${1}_CWM.zip || adb push /home/googy/Anas/Googy-Max3-Kernel/GT-I9505_GoogyMax3_GE-Kernel_${1}_CWM.zip /storage/sdcard1/GT-I9505_GoogyMax3_GE-Kernel_${1}_CWM.zip
